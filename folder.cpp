...
char* IITkgp_functions::folder::input_image_name_cut(const char *s)
{
 ...
 */
void IITkgp_functions::folder::makedir(char *name)
{
    int status;
...
char* IITkgp_functions::folder::CreateNameIntoFolder(char *foldername, char *desiredname )
{
